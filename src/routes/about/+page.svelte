	...
	<div class="work">
		...
		<div class="about">
			...
			<div class="right">
				...
				<article class="post">
					<p>Моя деятельность в web индустрии началась в 2008г.</p> 
					<p>Моя основная стихия фронтенд разработка.</p>
					<p>Очень много лет опыта я посвятил html-верстке, поэтому название сайта не случайно.</p>
					<p>Я участвовал в огромном количестве разных проектов и здесь я делюсь своим опытом.</p>
					<p><i>Основная масса статей посвящена интересным задачам, которые рано или поздно предстают перед разработчиками.</i></p>
					<p>С 2020 года активно изучаю <strong>svelte.js</strong>. Первые сайты создавал на фреймворке <strong>sapper</strong>.</p> 
