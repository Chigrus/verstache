...
<div class="maincontainer">
	<div class="header">
		<div class="wrap">
			<div class="work">
				<div class="about">
					<div class="tille">Профессиональное создание web интерфейсов.</div>
					<div class="text">Вам нужно лишь знать что вы хотите сдедлать, остальное я cделаю за вас. 
						Передовые инструменты создания интерфеса, скорость и качество работы вашего сайта.</div>
					<a href="/about" class="btn">О себе</a>
				</div>
			</div>
		</div>
		<div class="verstache">wwww.verstache.ru</div>
	</div>
</div>
